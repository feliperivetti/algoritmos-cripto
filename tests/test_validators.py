...
class TestValidators:
    ...
    @pytest.mark.parametrize("val, expected", [(1, True), (-1, True), (100, True), (0, False)])
    ...
    @pytest.mark.parametrize("val, expected", [(1, True), (10, True), (0, False), (-5, False)])
    ...
    @pytest.mark.parametrize(
        "val, expected", [(2, True), (10, True), (1, False), (0, False), (-2, False)]
    )
    ...
    @pytest.mark.parametrize(
        "val, expected", [(3, True), (1, True), (-3, True), (2, False), (0, False), (-4, False)]
    )
